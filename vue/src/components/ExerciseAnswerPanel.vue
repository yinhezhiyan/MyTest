<template>
  <div class="exercise-panel" v-if="q.id">
    ...
    <el-alert v-if="feedback.visible" :type="feedback.type" :title="feedback.title" show-icon :closable="false"/>
    <div class="actions">
...
const feedback = reactive({ visible: false, type: 'info', title: '' })
...
.action-row,.actions{display:flex;gap:8px;flex-wrap:wrap}
